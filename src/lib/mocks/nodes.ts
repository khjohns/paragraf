...
export const MOCK_NODES: GraphNode[] = [
  ...
  // KOFA cases
  {
    ...
    outcome: 'Brudd',
    category: 'A',
    signals: { ref: ['16-10'], fts: ['kapasitet'], vec: [0.82], discovery_rank: 3 },
    citations: 3,
    regulation: 'new',
    iteration: 1,
    isSeed: false,
    isDelimitation: false,
    detail:
      'Nemnda fant at oppdragsgiver br\u00f8t regelverket ved \u00e5 akseptere ESPD som tilstrekkelig dokumentasjon for r\u00e5dighet over st\u00f8ttende virksomhets kapasitet.',
  },
  {
    id: 'kofa:2022/789',
    type: 'kofa_case',
  ...
  },
  {
    ...
    outcome: 'Brudd',
    category: 'B',
    signals: { ref: ['16-10'], fts: ['kapasitet'], vec: [], discovery_rank: 2 },
    citations: 5,
    regulation: 'new',
    iteration: 1,
    isSeed: false,
  ...
  },
  {
    ...
    outcome: 'Ikke brudd',
    category: 'B',
    signals: { ref: ['16-10'], fts: [], vec: [0.75], discovery_rank: 2 },
    citations: 4,
    regulation: 'new',
    iteration: 1,
    isSeed: false,
  ...
  },
  {
    ...
    outcome: 'Ikke brudd',
    category: 'C',
    signals: { ref: [], fts: ['ettersending'], vec: [], discovery_rank: 1 },
    citations: 2,
    regulation: 'new',
    iteration: 1,
    isSeed: false,
  ...
  },
  {
    ...
    outcome: 'Brudd',
    category: 'C',
    signals: { ref: ['16-10'], fts: [], vec: [], discovery_rank: 1 },
    citations: 3,
    regulation: 'old',
    iteration: 1,
    isSeed: false,
