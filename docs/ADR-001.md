...
Kolonnene populeres under sync. Metadata-dekning etter sync (2026-02-09): ministry 100%, based_on 82%, legal_area 18%, keywords/language/date_end 0% (ikke i public API XML).
