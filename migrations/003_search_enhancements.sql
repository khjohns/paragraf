-- 003: Search enhancements
-- Adds: doc_type + legal_area filters to FTS, legal_area filter to hybrid, based_on in results
...
-- =============================================================================
-- 2. Updated search_lovdata_hybrid with legal_area filter + based_on
-- =============================================================================
...
BEGIN
    ...
    WITH
    filtered_docs AS (
        SELECT d.dok_id, d.short_title, d.doc_type, d.ministry, d.based_on
